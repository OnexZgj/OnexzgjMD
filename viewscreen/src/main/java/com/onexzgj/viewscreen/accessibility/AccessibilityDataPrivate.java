...
public class AccessibilityDataPrivate {
    ...
    private static void delegateViewAccessibilityDelegate(final Context context, final View view) {
        ...
        if (delegate == null || !(delegate instanceof WrapperAccessibilityDelegate)) {
            view.setAccessibilityDelegate(new WrapperAccessibilityDelegate(delegate));
        }
    ...
    public static void trackViewOnClick(View view) {
        try {
            ...
            jsonObject.put("$element_id", AccessibilityDataPrivate.getViewId(view));
            jsonObject.put("$element_content", AccessibilityDataPrivate.getElementContent(view));

            Activity activity = AccessibilityDataPrivate.getActivityFromView(view);
            if (activity != null) {
